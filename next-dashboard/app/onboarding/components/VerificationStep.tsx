    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="grid grid-cols-1 gap-8 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                className={`p-4 rounded-xl border text-[9px] font-bold uppercase tracking-widest transition-all flex flex-col items-center gap-2 ${
                  docType === t.id 
        ...
        <div 
          ...
          className={`p-10 border-2 border-dashed rounded-[2rem] flex flex-col items-center justify-center gap-4 bg-white/30 group transition-all cursor-pointer ${
            selectedFile && merchant.verificationStatus !== 'verified'
