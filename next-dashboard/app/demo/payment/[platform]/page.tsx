...
export default function PaymentSetup() {
  ...
  const handleContinue = () => {
    if (selected) {
      router.push(`/demo/success/${platform}`);
    }
  };
    ...
    <div className="max-w-3xl mx-auto pt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <button
          ...
          className={`relative p-8 rounded-2xl border-2 text-left transition-all ${selected === 'halo'
        ...
        <button
          ...
          className={`relative p-8 rounded-2xl border-2 text-left transition-all ${selected === 'manual'
